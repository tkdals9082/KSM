namespace KSM.Utility
{
    ...
    public static class UnityEventLambda<T0,T1,T2,T3>
    {
        ...
        private static Dictionary<int, (List<Expression<Action<T0,T1,T2,T3>>> expressions, List<Action<T0,T1,T2,T3>> actions)> dict = new Dictionary<int, (List<Expression<Action<T0,T1,T2,T3>>> expressions, List<Action<T0,T1,T2,T3>> actions)>();
        ...
        public static void AddListener(/*this*/ UnityEvent<T0,T1,T2,T3> unityEvent, Expression<Action<T0,T1,T2,T3>> expression)
        {
            Action<T0,T1,T2,T3> action = expression.Compile();
            ...
            {
                List<Expression<Action<T0,T1,T2,T3>>> expressions = new List<Expression<Action<T0,T1,T2,T3>>>() { expression };
                List<Action<T0,T1,T2,T3>> actions = new List<Action<T0,T1,T2,T3>>() { action };
        ...
        public static void RemoveListener(/*this*/ UnityEvent<T0,T1,T2,T3> unityEvent, Expression<Action<T0,T1,T2,T3>> expression)
        {
            int hash = unityEvent.GetHashCode();
