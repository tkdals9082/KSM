namespace KSM.Utility
{
    ...
    public static class UnityEventLambda<T0,T1,T2>
    {
        ...
        private static Dictionary<int, (List<Expression<Action<T0,T1,T2>>> expressions, List<Action<T0,T1,T2>> actions)> dict = new Dictionary<int, (List<Expression<Action<T0,T1,T2>>> expressions, List<Action<T0,T1,T2>> actions)>();
        ...
        public static void AddListener(/*this*/ UnityEvent<T0,T1,T2> unityEvent, Expression<Action<T0,T1,T2>> expression)
        {
            Action<T0,T1,T2> action = expression.Compile();
            ...
            {
                List<Expression<Action<T0,T1,T2>>> expressions = new List<Expression<Action<T0,T1,T2>>>() { expression };
                List<Action<T0,T1,T2>> actions = new List<Action<T0,T1,T2>>() { action };
        ...
        public static void RemoveListener(/*this*/ UnityEvent<T0,T1,T2> unityEvent, Expression<Action<T0,T1,T2>> expression)
        {
            int hash = unityEvent.GetHashCode();
