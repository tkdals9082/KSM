...
namespace KSM.Utility
{
    ...
    public static class UIExtensions
    {
        ...
        /// <returns></returns>
        public static string AddOrdinalDecoration(this string ordinalNumber, float fontSize, float sizeRatio = 0.66f)
        {
            string decoration = "";
            if (ordinalNumber == "1")
            {
                decoration = $"<size={fontSize * 2 / 3}>" + "st" + "</size>";
            }
            else if (ordinalNumber == "2")
            {
                decoration = $"<size={fontSize * 2 / 3}>" + "nd" + "</size>";
            }
            else if (ordinalNumber == "3")
            {
                decoration = $"<size={fontSize * 2 / 3}>" + "rd" + "</size>";
            }
            else
            {
                decoration = $"<size={fontSize * 2 / 3}>" + "th" + "</size>";
            }
